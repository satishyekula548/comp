...
let TasksController = class TasksController {
    ...
    async getTaskAttachments(organizationId, taskId) {
        ...
        return await this.attachmentsService.getAttachments(organizationId, taskId, _db_1.AttachmentEntityType.task);
    }
    async uploadTaskAttachment(authContext, taskId, uploadDto) {
        ...
        return await this.attachmentsService.uploadAttachment(authContext.organizationId, taskId, _db_1.AttachmentEntityType.task, uploadDto, authContext.userId);
    }
